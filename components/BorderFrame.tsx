    ...
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-50">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 0%, #1a1008 20%, #e87a2a40 50%, #1a1008 80%, transparent 100%)",
            backgroundSize: "200% 100%",
            animation: "border-slide 6s ease-in-out infinite",
            boxShadow: "0 0 8px rgba(232,122,42,0.04), 0 0 20px rgba(232,122,42,0.02)",
          }}
        />
        {/* Bottom */}
        <div
      ...
      <div className="fixed top-0 left-10 w-px h-screen z-[49] pointer-events-none hidden lg:block">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(180deg, transparent, rgba(232,122,42,0.3), transparent)",
            boxShadow: "0 0 6px rgba(232,122,42,0.15), 0 0 15px rgba(232,122,42,0.06)",
      ...
      {[
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(90deg, #e87a2a33, transparent)" }}
          />
          <div
            className="absolute top-0 left-0 w-px h-20"
            style={{ background: "linear-gradient(180deg, #e87a2a33, transparent)" }}
          />
        </div>
      ))}
    </>
