...
export default function BotShowcase() {
  ...
  return (
    <section className="min-h-screen lg:h-screen lg:snap-start lg:snap-always lg:overflow-hidden px-6 border-t border-[#0e0e0e] flex flex-col justify-center py-24 lg:py-0">
          ...
          <FadeIn delay={0.15}>
            ...
            >
              ...
              <div className="mb-5 pb-5 border-b border-[#111]">
                <span className="text-[#22d3ee] font-medium">dev_mike:</span>
                <span className="text-[#666]">
